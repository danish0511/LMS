...
const CallToAction = (props: Props) => {
    return (
        <div className="flex flex-col items-start md:items-center gap-y-5 md:gap-y-8">
            <GradientText
            ...
            <p className="text-sm md:text-center text-left text-muted-foreground">
                Grouple is a vibrant online community platform that enpowers{" "}
            ...
            <div className="flex md:flex-row flex-col md:justify-center gap-5 md:mt-5 w-full">
                ...
                <Link href="/sign-in">
                    <Button className="rounded-cl text-base flex-gap-2 w-full">
